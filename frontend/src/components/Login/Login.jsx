...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute justify-center text-white top-[22%] left-[45%]">
        <BsDroplet className=" animate-bounce" size={35} />
      </div>
      <div className=" sm:mx-auto sm:w-full sm:max-w-md max-400px:h-[70vh] px-4 pt-[14%]">
            ...
            <div>
              ...
              <div className="mt-1 ">
                <input
                  ...
                  className=" h-10 appearance-none block w-full px-3 py-2 border border-blue-500 rounded-full shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
            <div>
